...
for task, data_dir in datasets:
    print(f"==========================================")
    print(f"Running: BERT-base on {task}")
    print(f"==========================================")

    # Start GPU logger
    gpu_log = f"bertbase_{task}_gpu_log.csv"
    ...
    cmd = [
        ...
        "--learning_rate", "2e-5",
        "--num_train_epochs", "3",
        "--output_dir", f"outputs/bertbase_{task}",
        "--quantized_model_dir", f"quantized_models/bertbase_{task}",
    ...
    print(f"Done: BERT-base on {task}")

print("All BERT-base datasets completed.")
